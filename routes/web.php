...
Route::get('/index-cart', [CartController::class,'AddCart'])->name('indexcart');   

Route::get('/xoa-all', [CartController::class,'DeleteListItemCart']);   

Route::get('/admin.formchonchitiet',[ChitietspriengController::class,'formsuactspr'])->name('suactspr');
