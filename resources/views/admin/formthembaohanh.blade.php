                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ma bao hanh</label>
                                            <input class="form-control" type="text" placeholder="abcxyz" id="example-text-input" name="mabh">
                                        </div>
                                       
                                        <div class="form-group">
                                            <label for="example-email-input" class="col-form-label">ma chi tiet san pham rieng</label>
                                            <input class="form-control" type="text"  id="example-email-input" name="maspr">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-url-input" class="col-form-label">ma san pham</label>
                                            <input class="form-control" type="text"  id="example-url-input" name="masp">
                                        </div>
                                        <div class="form-group">
